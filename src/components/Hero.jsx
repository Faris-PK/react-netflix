        ...
        <div className='absolute w-full h-[550px] lg:h-[850px] bg-gradient-to-r from-black'/>
          ...
          <div className='absolute w-full top-[20%] lg:top-[30%] p-4 md:p-8 '>
            ...
            <div className='mt-8 mb-4'>
              ...
              <button
              className='capitalize border bg-gray-300 text-black py-2 px-5 transition-all duration-300 ease-in-out hover:bg-gray-400 hover:text-white'
            >
              Play
            </button>
            <button
              className='capitalize border border-gray-300 py-2 px-5 ml-4 transition-all duration-300 ease-in-out hover:bg-gray-300 hover:border-gray-400'
            >
              Watch later
            </button>
